...
enum {
  ...
  TT_POINT_SUBTYPE_WALKWAY,
  TT_POINT_SUBTYPE_WALKWAYMETALIC,
  TT_POINT_SUBTYPE_WALKWAYSOIL,
  TT_POINT_SUBTYPE_WALKWAYSTONE,
  TT_POINT_SUBTYPE_WALKWAYWOOD,
};
...
static const thstok thtt_point_subtypes[] = {
  ...
  {"metalic", TT_POINT_SUBTYPE_WALKWAYMETALIC},
  ...
  {"soil", TT_POINT_SUBTYPE_WALKWAYSOIL},
  {"stone", TT_POINT_SUBTYPE_WALKWAYSTONE},
  ...
  {"wood", TT_POINT_SUBTYPE_WALKWAYWOOD},
